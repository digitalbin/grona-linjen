...
<button on:click={toggleOpen} class:isOpen id="menuBtn" aria-label="Menu button">
	<svg viewBox="0 0 385 383" xmlns="http://www.w3.org/2000/svg" fill="none">
		...
		<g class="lever">
			<path
				...
				stroke="currentColor"
			/>
			<circle cx="172" cy="278" r="53" stroke-width="20" stroke="currentColor" />
		</g>
	</svg>
</button>
